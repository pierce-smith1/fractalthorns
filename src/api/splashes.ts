...
export const discord_splash_upload_request = {
    text: {
        type: Interfaces.fields.required_string,
        description: "The text of the splash. This may not be longer than 80 characters; if so, the request will fail with a 400. Control characters, such as line breaks, are also disallowed, and if present the request will fail with a 400. Substrings that represent custom fractalthorns emoji (i.e., of the form '<:(name):(id)>' where name is a fractalthorns emoji such as lksix, cvjoy, etc.) will only count as two characters for the purposes of the character limit. "
    },
